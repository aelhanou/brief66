...
export const Reservation = () => {
  ...
  return (
    <Loading>
      <div
        className=" w-full lg:items-top md:flex sm:flex-wrap sm:items-top md:flex-wrap md:h-screen md:items-top overflow-y-hidden  md:m-auto flex-col  h-screen flex gap-14 shadow-2xl justify-center bg-cover bg-center bg-no-repeat "
        style={{
      ...
      >
        ...
        <div className='header  justify-center w-full flex gap-8 text-right p-2'>
          ...
          <img className=" w-full flex justify-center" src={logolabel} alt="" />
